...
var App = /** @class */ (function (_super) {
    ...
    function App() {
        ...
        _this.handleINeedNoteTaker = function () {
            console.log("J'ai besoin d'un preneur de noteee");
        };
        _this.handleBecomeNoteTaker = function () {
            console.log("Je veux devenir un preneur de note");
        };
        return _this;
    }
    App.prototype.render = function () {
        return (React.createElement("div", { style: styles.main_container },
            React.createElement("div", { style: styles.nav },
                React.createElement("button", { style: styles.connexion_button }, "Connexion")),
            React.createElement("div", { style: styles.inscription },
                React.createElement("div", { style: styles.I_need_note_taker, onClick: this.handleINeedNoteTaker }),
                React.createElement("div", { style: styles.become_note_taker, onClick: this.handleBecomeNoteTaker })),
            React.createElement("p", { style: { position: "fixed", top: "60%", left: "25%", transform: "translate(-50%, -50%)" } }, "J'ai besoin d'un preneur de note"),
            React.createElement("p", { style: { position: "fixed", top: "60%", left: "75%", transform: "translate(-50%, -50%)" } }, "Je veux devenir preneur de note"),
            React.createElement("p", { style: { position: "fixed", top: "50%", left: "50%", transform: "translate(-50%, -50%)" } }, "\u2B05\uFE0F Inscription \u27A1\uFE0F")));
    };
    return App;
}(React.Component));
exports.default = App;
